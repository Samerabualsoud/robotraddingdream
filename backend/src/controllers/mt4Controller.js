...
class MT4Controller {
  ...
  modifyPosition = async (req, res) => {
    try {
      ...
      console.error(`Modify position error for ticket ${req.params.ticket}:`, error);
      return res.status(500).json({
        success: false,
  ...
  closePosition = async (req, res) => {
    try {
      ...
      console.error(`Close position error for ticket ${req.params.ticket}:`, error);
      return res.status(500).json({
        success: false,
